...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		...
		presets: {
			specificDate: 'Data especifica',
			allDatesBefore: 'Todas as datas antes',
			allDatesAfter: 'Todas as datas apos',
			dateRange: 'Per&iacute;odo'
		},
		rangeStartTitle: 'Data inicio',
		rangeEndTitle: 'Data fim',
		nextLinkText: 'Pro',
		prevLinkText: 'Ant',
		doneButtonText: 'Ok',
		earliestDate: Date.parse('-20years'), //earliest date allowed
		latestDate: Date.parse('+20years'), //latest date allowed
